...
function Install_dependencies()
    ...
    local libs = {
        ...
        {url="https://github.com/OUIsolutions/CAmalgamator/releases/download/0.0.4/CAmalgamatorApiNoDependenciesIncluded.h",path="dependencies/CAmalgamatorApiNoDependenciesIncluded.h"},
