...
function Install_dependencies()
    ...
    local libs = {
        ...
        {url="https://github.com/OUIsolutions/CAmalgamator/releases/download/0.001/CAmalgamatorApiNoDependenciesIncluded.h",path="dependencies/CAmalgamatorApiNoDependenciesIncluded.h"},
