...
---@field generate_amalgamation_verifier fun(filename:string,verifier:fun(include:string,path:string):"dont-include"| "dont-change" | "include-once" | "include-perpetual",max_content_size:number | nil,max_recursion:number|nil)
---@field ONE_MB number
